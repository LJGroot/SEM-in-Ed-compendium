...
```{r label="fig27-1", engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'svg', echo = FALSE, fig.cap="Random intercept model for alcohol-use data from Duncan and Duncan (1996)."}
